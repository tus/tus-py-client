...
htmlhelp_basename = 'tusclientdoc'
...
latex_documents = [
    (master_doc, 'tusclient.tex', u'tusclient Documentation',
     u'Author', 'manual'),
]
...
man_pages = [
    (master_doc, 'tusclient', u'tusclient Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'tusclient', u'tusclient Documentation',
     author, 'tusclient', 'One line description of project.',
     'Miscellaneous'),
]
